    ...
    public partial class MuestraProveedor : MaterialForm
    {
        ...
        private void Cell_Click(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && dgvProveedor.Columns[e.ColumnIndex].Name == "btn_seleccionar")
            {
                ...
                Clases.Datos.cuit_prov = Convert.ToDecimal(dgvProveedor.Rows[e.RowIndex].Cells["Column0"].Value);
                Clases.Datos.nom_prov = Convert.ToString(dgvProveedor.Rows[e.RowIndex].Cells["Column1"].Value);
        ...
        private void MuestraProveedor_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Close();
        }
    }
