namespace SistemaEE.Formularios
{
    partial class Menu
    {
        ...
        private void InitializeComponent()
        {
            ...
            mr_modoAzul = new MaterialSkin.Controls.MaterialRadioButton();
            mr_modoVerde = new MaterialSkin.Controls.MaterialRadioButton();
            mr_modoNaranja = new MaterialSkin.Controls.MaterialRadioButton();
            ...
            txt_cuitEmpresa.Font = new Font("Roboto", 16F, FontStyle.Regular, GraphicsUnit.Pixel);
            ...
            // 
            mr_modoAzul.Depth = 0;
            mr_modoAzul.Font = new Font("Segoe UI", 8.25F, FontStyle.Regular, GraphicsUnit.Point);
            mr_modoAzul.Location = new Point(374, 116);
            mr_modoAzul.Margin = new Padding(0);
            mr_modoAzul.MouseLocation = new Point(-1, -1);
            mr_modoAzul.MouseState = MaterialSkin.MouseState.HOVER;
            mr_modoAzul.Name = "mr_modoAzul";
            mr_modoAzul.Ripple = true;
            mr_modoAzul.Size = new Size(190, 34);
            mr_modoAzul.TabIndex = 176;
            mr_modoAzul.TabStop = true;
            mr_modoAzul.Text = "Azul";
            mr_modoAzul.UseVisualStyleBackColor = true;
            mr_modoAzul.CheckedChanged += mr_modoAzul_CheckedChanged;
            // 
            // mr_modoVerde
            // 
            mr_modoVerde.Depth = 0;
            mr_modoVerde.Font = new Font("Segoe UI", 8.25F, FontStyle.Regular, GraphicsUnit.Point);
            mr_modoVerde.Location = new Point(374, 77);
            mr_modoVerde.Margin = new Padding(0);
            mr_modoVerde.MouseLocation = new Point(-1, -1);
            mr_modoVerde.MouseState = MaterialSkin.MouseState.HOVER;
            mr_modoVerde.Name = "mr_modoVerde";
            mr_modoVerde.Ripple = true;
            mr_modoVerde.Size = new Size(190, 34);
            mr_modoVerde.TabIndex = 175;
            mr_modoVerde.TabStop = true;
            mr_modoVerde.Text = "Verde";
            mr_modoVerde.UseVisualStyleBackColor = true;
            mr_modoVerde.CheckedChanged += mr_modoVerde_CheckedChanged;
            // 
            // mr_modoNaranja
            // 
            mr_modoNaranja.Depth = 0;
            mr_modoNaranja.Font = new Font("Segoe UI", 8.25F, FontStyle.Regular, GraphicsUnit.Point);
            mr_modoNaranja.Location = new Point(374, 36);
            mr_modoNaranja.Margin = new Padding(0);
            mr_modoNaranja.MouseLocation = new Point(-1, -1);
            mr_modoNaranja.MouseState = MaterialSkin.MouseState.HOVER;
            mr_modoNaranja.Name = "mr_modoNaranja";
            mr_modoNaranja.Ripple = true;
            mr_modoNaranja.Size = new Size(190, 34);
            mr_modoNaranja.TabIndex = 174;
            mr_modoNaranja.TabStop = true;
            mr_modoNaranja.Text = "Naranja";
            mr_modoNaranja.UseVisualStyleBackColor = true;
            mr_modoNaranja.CheckedChanged += mr_modoNaranja_CheckedChanged;
            // 
            // btn_datosEmpresa
            // 
            ...
            ImagenesTab.Images.SetKeyName(2, "bell-solid.png");
